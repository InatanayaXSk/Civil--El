      ...
      <div className="sustainable-agriculture-container max-w-7xl mx-auto px-4">
        <div id="what-is-sustainable-agriculture" className="mb-12">
          ...
          <p className="text-justify mb-4">
            Welcome to EcoGuard - where technology meets sustainable agriculture. Our innovative plant leaf disease detection system helps farmers maintain crop health while promoting environmental sustainability.
          </p>
        ...
        <div id="join-us" className="mb-12 text-center bg-green-50 p-8 rounded-lg">
          ...
          <a href="mailto:info@example.com?subject=Join%20EcoGuard&body=I%20am%20interested%20in%20implementing%20smart%20disease%20detection." className="inline-block bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors">
            Get Started Now
          </a>
        </div>
        ...
        <footer className="mt-12 p-4 bg-gray-100 rounded-lg">
          <div className="text-center">
            ...
            <p className="italic">
              <b>techbire</b> © 2023 EcoGuard - Plant Disease Detection. All rights reserved.
            </p>
          </div>
        </footer>
      </div>
